...
provided with each release as an SBOM artifact and in the release metadata.
The installer bundles include the notices and license texts required by the
distributed components.

## Node-based canvas UI
